[Skip to main content](https://docs.mem0.ai/platform/faqs#content-area)
...
Best PracticesTo ensure successful memory extraction:
...
[Suggest edits](https://github.com/mem0ai/mem0/edit/main/docs/platform/faqs.mdx) [Raise issue](https://github.com/mem0ai/mem0/issues/new?title=Issue%20on%20docs&body=Path:%20/platform/faqs)

[MCP Integration\\
\\
Previous](https://docs.mem0.ai/platform/features/mcp-integration) [Migrate from Open Source to Platform\\
\\
Next](https://docs.mem0.ai/migration/oss-to-platform)
